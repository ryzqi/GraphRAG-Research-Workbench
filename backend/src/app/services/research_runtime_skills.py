...
6. Keep the `[plan-step-<index>]` todo statuses updated as you progress through planner subtasks. `plan_progress_snapshot` is derived from these todos; do not invent a second plan-progress channel.
