...
KB_CHAT_NODE_METADATA: dict[str, dict[str, Any]] = {
    ...
    "entity_expand": {"label": "实体扩展", "phase": "enhance", "order": 8},
    "hyde": {"label": "假设文档扩展", "phase": "enhance", "order": 9},
    "query_plan_finalize": {"label": "查询定稿", "phase": "enhance", "order": 10},
    "preprocess_exit": {"label": "预处理出口", "phase": "enhance", "order": 11},
    "retrieval_subgraph": {"label": "检索子图", "phase": "retrieve", "order": 12},
    "retrieval_plan": {"label": "检索预算规划", "phase": "retrieve", "order": 13},
    "dispatch_subqueries": {"label": "子查询派发", "phase": "retrieve", "order": 14},
    "retrieve_subquery": {"label": "子查询检索", "phase": "retrieve", "order": 15},
    "merge_subquery_context": {"label": "子查询上下文合并", "phase": "retrieve", "order": 16},
    "retrieve": {"label": "知识检索", "phase": "retrieve", "order": 17},
    "context_compress": {"label": "上下文压缩", "phase": "retrieve", "order": 18},
    "transform_query": {"label": "查询改写", "phase": "retrieve", "order": 19},
    "answer_subgraph": {"label": "答案子图", "phase": "generate", "order": 20},
