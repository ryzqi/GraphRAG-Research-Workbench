...
KB_CHAT_NODE_METADATA: dict[str, dict[str, Any]] = {
    ...
    "query_plan": {"label": "查询规划", "phase": "preprocess", "order": 5},
    "preprocess_exit": {"label": "预处理出口", "phase": "preprocess", "order": 6},
    "retrieval_subgraph": {"label": "检索子图", "phase": "retrieve", "order": 7},
    "retrieval_plan": {"label": "检索预算规划", "phase": "retrieve", "order": 8},
    "dispatch_subqueries": {"label": "子查询派发", "phase": "retrieve", "order": 9},
    "retrieve_subquery": {"label": "子查询检索", "phase": "retrieve", "order": 10},
    "merge_subquery_context": {"label": "子查询上下文合并", "phase": "retrieve", "order": 11},
    "retrieve": {"label": "知识检索", "phase": "retrieve", "order": 12},
    "context_compress": {"label": "上下文压缩", "phase": "retrieve", "order": 13},
    "transform_query": {"label": "查询改写", "phase": "retrieve", "order": 14},
    "answer_subgraph": {"label": "答案子图", "phase": "generate", "order": 15},
    "draft_generate": {"label": "草稿生成", "phase": "generate", "order": 16},
    "answer_review_dispatch": {"label": "审查分发", "phase": "verify", "order": 17},
    "answer_review_citation": {"label": "引用覆盖审查", "phase": "verify", "order": 18},
    "answer_review_factual": {"label": "事实正确性审查", "phase": "verify", "order": 19},
    "answer_review_answerability": {"label": "可回答性审查", "phase": "verify", "order": 20},
    "answer_review_fuse": {"label": "审查结果融合", "phase": "verify", "order": 21},
    "answer_repair": {"label": "答案修复", "phase": "verify", "order": 22},
    "answer_commit": {"label": "答案提交", "phase": "generate", "order": 23},
    "force_exit": {"label": "提前终止", "phase": "finalize", "order": 24},
}
