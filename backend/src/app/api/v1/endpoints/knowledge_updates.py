...
async def create_proposal(
    req: ProposalCreate, session: AsyncSessionDep
) -> ProposalRead:
    """创建候选沉淀。"""
...
async def get_proposal(
    proposal_id: uuid.UUID, session: AsyncSessionDep
) -> ProposalRead:
    """获取候选沉淀详情。"""
...
async def update_proposal(
    proposal_id: uuid.UUID, req: ProposalUpdate, session: AsyncSessionDep
) -> ProposalRead:
    """更新候选沉淀状态。"""
