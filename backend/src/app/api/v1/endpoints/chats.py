...
async def get_kb_chat_graph_schema(
    ...
    decomposition_max_sub_questions: int | None = Query(None, ge=2, le=4),
    multi_query_enabled: bool | None = Query(None),
    multi_query_max_variants: int | None = Query(None, ge=2, le=4),
    ...
    raw_config = {
        ...
        for key, value in {
            ...
            "decomposition_max_sub_questions": decomposition_max_sub_questions,
