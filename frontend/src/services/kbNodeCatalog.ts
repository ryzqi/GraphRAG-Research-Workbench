...
export const KB_NODE_CATALOG: Record<string, KbNodeCatalogEntry> = {
  ...
  entity_expand: { label: '实体扩展', stageId: 'stage_3_enhance', order: 8, icon: QueryStatsIcon, color: C.preprocess, phase: 'enhance' },
  hyde: { label: '假设文档扩展', stageId: 'stage_3_enhance', order: 9, icon: AutoAwesomeIcon, color: C.preprocess, phase: 'enhance' },
  query_plan_finalize: { label: '查询定稿', stageId: 'stage_3_enhance', order: 10, icon: TextSnippetIcon, color: C.preprocess, phase: 'enhance' },
  preprocess_exit: { label: '预处理出口', stageId: 'stage_3_enhance', order: 11, icon: TaskAltIcon, color: C.preprocess, phase: 'enhance' },
  retrieval_subgraph: { label: '检索子图', stageId: 'stage_4_retrieve', order: 12, icon: AccountTreeIcon, color: C.retrieve, phase: 'retrieve' },
  retrieval_plan: { label: '检索预算规划', stageId: 'stage_4_retrieve', order: 13, icon: QueryStatsIcon, color: C.retrieve, phase: 'retrieve' },
  dispatch_subqueries: { label: '子查询派发', stageId: 'stage_4_retrieve', order: 14, icon: HubIcon, color: C.retrieve, phase: 'retrieve' },
  retrieve_subquery: { label: '子查询检索', stageId: 'stage_4_retrieve', order: 15, icon: SearchIcon, color: C.retrieve, phase: 'retrieve' },
  merge_subquery_context: { label: '子查询上下文合并', stageId: 'stage_4_retrieve', order: 16, icon: MergeTypeIcon, color: C.retrieve, phase: 'retrieve' },
  retrieve: { label: '知识检索', stageId: 'stage_4_retrieve', order: 17, icon: SearchIcon, color: C.retrieve, phase: 'retrieve' },
  context_compress: { label: '上下文压缩', stageId: 'stage_4_retrieve', order: 18, icon: TuneIcon, color: C.retrieve, phase: 'retrieve' },
  transform_query: { label: '查询改写', stageId: 'stage_4_retrieve', order: 19, icon: TuneIcon, color: '#DC2626', phase: 'retrieve' },
  answer_subgraph: { label: '答案子图', stageId: 'stage_6_answer', order: 20, icon: AccountTreeIcon, color: C.answer, phase: 'generate' },
