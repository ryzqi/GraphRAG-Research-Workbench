...
export const KB_NODE_CATALOG: Record<string, KbNodeCatalogEntry> = {
  ...
  query_plan: { label: '查询规划', stageId: 'stage_2_route', order: 5, icon: TextSnippetIcon, color: C.preprocess, phase: 'route' },
  decomposition: { label: '问题拆解', stageId: 'stage_3_enhance', order: 6, icon: AccountTreeIcon, color: C.preprocess, phase: 'enhance' },
  generate_variants: { label: '多路查询扩展', stageId: 'stage_3_enhance', order: 7, icon: HubIcon, color: C.preprocess, phase: 'enhance' },
  hyde: { label: '假设文档扩展', stageId: 'stage_3_enhance', order: 8, icon: AutoAwesomeIcon, color: C.preprocess, phase: 'enhance' },
  query_plan_finalize: { label: '查询定稿', stageId: 'stage_3_enhance', order: 9, icon: TextSnippetIcon, color: C.preprocess, phase: 'enhance' },
  preprocess_exit: { label: '预处理出口', stageId: 'stage_3_enhance', order: 10, icon: TaskAltIcon, color: C.preprocess, phase: 'enhance' },
  retrieval_subgraph: { label: '检索子图', stageId: 'stage_4_retrieve', order: 11, icon: AccountTreeIcon, color: C.retrieve, phase: 'retrieve' },
  retrieval_plan: { label: '检索预算规划', stageId: 'stage_4_retrieve', order: 12, icon: QueryStatsIcon, color: C.retrieve, phase: 'retrieve' },
  dispatch_subqueries: { label: '子查询派发', stageId: 'stage_4_retrieve', order: 13, icon: HubIcon, color: C.retrieve, phase: 'retrieve' },
  retrieve_subquery: { label: '子查询检索', stageId: 'stage_4_retrieve', order: 14, icon: SearchIcon, color: C.retrieve, phase: 'retrieve' },
  merge_subquery_context: { label: '子查询上下文合并', stageId: 'stage_4_retrieve', order: 15, icon: MergeTypeIcon, color: C.retrieve, phase: 'retrieve' },
  retrieve: { label: '知识检索', stageId: 'stage_4_retrieve', order: 16, icon: SearchIcon, color: C.retrieve, phase: 'retrieve' },
  context_compress: { label: '上下文压缩', stageId: 'stage_4_retrieve', order: 17, icon: TuneIcon, color: C.retrieve, phase: 'retrieve' },
  transform_query: { label: '查询改写', stageId: 'stage_4_retrieve', order: 18, icon: TuneIcon, color: '#DC2626', phase: 'retrieve' },
  answer_subgraph: { label: '答案子图', stageId: 'stage_6_answer', order: 19, icon: AccountTreeIcon, color: C.answer, phase: 'generate' },
  draft_generate: { label: '草稿生成', stageId: 'stage_6_answer', order: 20, icon: AutoAwesomeIcon, color: C.answer, phase: 'generate' },
  answer_review_dispatch: { label: '审查分发', stageId: 'stage_6_answer', order: 21, icon: RateReviewIcon, color: C.answer, phase: 'verify' },
  answer_review_citation: { label: '引用覆盖审查', stageId: 'stage_6_answer', order: 22, icon: RateReviewIcon, color: C.answer, phase: 'verify' },
  answer_review: { label: '回答有效性审查', stageId: 'stage_6_answer', order: 23, icon: RateReviewIcon, color: C.answer, phase: 'verify' },
  answer_review_fuse: { label: '审查结果融合', stageId: 'stage_6_answer', order: 24, icon: RateReviewIcon, color: C.answer, phase: 'verify' },
