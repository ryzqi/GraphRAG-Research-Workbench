...
export const KB_NODE_CATALOG: Record<string, KbNodeCatalogEntry> = {
  ...
  generate: { label: '答案生成', stageId: 'stage_6_answer', order: 29, icon: AutoAwesomeIcon, color: C.answer, phase: 'generate' },
  ...
  answer_review: { label: '答案审查', stageId: 'stage_6_answer', order: 34, icon: RateReviewIcon, color: C.answer, phase: 'verify' },
