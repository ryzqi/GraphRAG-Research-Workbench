...
export function ResearchCanvas({
  ...
  return (
    <Stack spacing={2.5}>
      <ResearchPhaseTransition phaseKey="current-step" index={0}>
      ...
      <ResearchPhaseTransition phaseKey="findings" index={1}>
        <Paper variant="outlined" sx={sectionSx}>
      ...
      <ResearchPhaseTransition phaseKey="final-report" index={2} emphasis>
        <Paper variant="outlined" sx={sectionSx}>
          <Stack spacing={1.5}>
